...
for i = 1 : length(t)
	...
	[d_cho_2(i), Ug_2(i), Dm1_2(i+1), Dm2_2(i+1),G_2(i), Q1_2(i+1), Q2_2(i+1), Ui_2(i), S1_2(i+1), S2_2(i+1), I_2(i+1), x1_2(i+1), x2_2(i+1), x3_2(i+1), u_2(i+1)] = Hovorka_eat20(step, tau_d, Ag, Mwg, F01, EGP, Vg, k12, Vi, tau_s, ka1, ka2, ka3, ke, Sit, Sid, Sie, Dm1_2(i), Dm2_2(i), Q1_2(i), Q2_2(i), S1_2(i), S2_2(i), I_2(i), x1_2(i), x2_2(i), x3_2(i), u_2(i), eat_2, t(i));
...
hold off;
legend('Eat 10 g', 'Eat 20 g', 'Normal glucose'); 
